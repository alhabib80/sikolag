    ...
    <div class="wrapper">
      ...
      <div class="content-wrapper">
        ...
        <div class='alert alert-warning alert-dismissible fade in' role='alert' style='border-radius:0px; margin-bottom:0px'>
          ...
          <a href="https://members.phpmu.com/" style="margin-right:10px; text-decoration:none;">Haloo Selamat datang di halaman administrator, Saat ini anda menggunakan SIKOLAG Ci</a>
          <a target='_BLANK' class="btn btn-default btn-sm" href="https://members.phpmu.com/" style="color: rgb(243, 156, 18);">SIKOLAG Ci 1.0</a>
        </div>
      <?php } ?>
